...
class Transition {
    ...
    render() {
        ...
        const eachRoundScore = Math.abs(this.score - score);
        this.score = score;
        ...
        } else if(this.roundNumber === 3 && eachRoundScore < 100) {
        ...
        } else if(this.roundNumber === 3 && eachRoundScore <= 150) {
